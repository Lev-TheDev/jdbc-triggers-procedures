...
public class EmployeeDAO {
    ...
    public List<EmployeeEntity> findAll(){
        ...
        try(
            ...
            statement.executeQuery("SELECT * FROM employees ORDER BY birthday asc");
            //statement.executeQuery("SELECT * FROM employees WHERE id > 1 AND name like '%a%' ORDER BY birthday asc");
